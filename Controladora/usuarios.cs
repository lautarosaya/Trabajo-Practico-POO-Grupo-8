...
namespace Controladora
{
    public class usuarios
    {
        ...
        public MailMessage Mail_Registro(string usuario_mail, string usuario_nombre, string usuario_apellido)
        {
            ...
            correo.From = new MailAddress("sanchezautomotoroficial@gmail.com");
        ...
        public SmtpClient SmtpClient()
        {
            ...
            smtpClient.Credentials = new System.Net.NetworkCredential("sanchezautomotoroficial@gmail.com", "Fsautomotores");
